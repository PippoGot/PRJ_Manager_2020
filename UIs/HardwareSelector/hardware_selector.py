...
class Ui_uiHardwareSelector(object):
    def setupUi(self, uiHardwareSelector):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.uiQuanity.sizePolicy().hasHeightForWidth())
        self.uiQuanity.setSizePolicy(sizePolicy)
        self.uiQuanity.setMinimumSize(QtCore.QSize(75, 0))
        self.uiQuanity.setObjectName("uiQuanity")
        self.horizontalLayout.addWidget(self.uiQuanity)
